...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .top-bar{background:var(--rose);color:#fff;text-align:center;padding:14px 10px;
    ...
    .btn{display:inline-block;padding:14px 20px;border-radius:14px;font-weight:900;
    ...
    .grad-left{font-size:clamp(34px,4.8vw,50px);line-height:1.1;margin:0 0 12px;font-weight:900;
    ...
    .faq-q{width:100%; text-align:left; background:#fff; border:0; padding:16px 18px;
    ...
    .whats-float{position:fixed; right:40px; top:50%; transform:translateY(-50%); z-index:1000;
    ...
    @media (max-width:640px){.whats-float{top:auto; bottom:18px; right:18px; transform:none;}}
  </style>
</head>
<body>
  ...
  <section id="depoimentos">
    <div class="wrap">
      ...
      <div class="testimonials">
        ...
        <div class="t-card man"><p class="t-name">Mateus Battistela</p><p>Hoje valeu a pena porque aprendi um pouco mais...</p></div>
        <!-- demais depoimentos -->
      </div>
    </div>
  </section>
  ...
  <section id="inscricao" style="padding:40px 20px">
    <div class="wrap" style="text-align:center">
      ...
      <a href="https://docs.google.com/forms/d/e/1FAIpQLSc7wsV5YQcTsjH9x3CSAVRu13jba3_sSbD39dFqQgxWprBqXQ/viewform" class="btn primary" target="_blank" rel="noopener">Abrir formulário de inscrição</a>
    </div>
  </section>
