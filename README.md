...
<body>
  ...
  <main class="container">
      ...
      <div class="grid two">
        ...
        <div class="card">
          ...
          <ul class="list-check">
            ...
            <li><strong>Compromisso consciente</strong>: escolher amar todos os dias;</li>
            <li><strong>Resgate do prazer e da parceria</strong>.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section id="como-sera">
      <h2>Como será esse dia?</h2>
      <div class="grid two">
        <div>
          <p>• Um encontro imersivo com dinâmicas, reflexões, música e momentos de entrega.</p>
          <p>• Um espaço seguro, amoroso e inspirador para viver <strong>uma história dentro da sua própria história</strong>.</p>
          <p>• <strong>Um dia inteiro</strong> para olhar aquilo que, na correria, passa despercebido: <em>a pessoa que está ao seu lado</em>.</p>
          <p>• Entender como o parceiro realmente funciona, o que gosta, e compreender <strong>dinâmicas ocultas</strong> que influenciam a relação.</p>
          <p>• Ao final, vocês saem mais conectados, leves e com um novo pacto de amor para a vida a dois.</p>
        </div>
        <div class="card">
          <span class="pill">Informações</span>
          <p class="muted">Data & Local: <em>a confirmar</em></p>
